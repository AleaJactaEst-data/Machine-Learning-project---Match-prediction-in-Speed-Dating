...
tune_grid <- expand.grid(C=c(2000, 5000, 10000, 100000), sigma = seq(0.01,0.4,0.05))
...
# resultat pour gamma = 
res = optimisationNeuroneDeeplearning(0.1, 20, 0.5, 500, xtrain, xtest,ytrain, ytest);
...
focal_loss=function(y_true, y_pred){
  gamma = 3.5 # 3.8 a 7.5 fonctionne > test - amelioration surechantilonage
  print("gamma")
...
model %>% 
  layer_dense(units = (ncol)*0.8, input_shape = c(ncol), activation = "sigmoid") %>%
