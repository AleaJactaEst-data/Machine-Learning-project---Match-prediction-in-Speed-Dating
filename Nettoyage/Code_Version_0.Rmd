...
varSignificatifs2 = c( "age_ect" , "imprace_moy" , "dining_moy" ,
    "museums_moy" , "art_moy" ,  "clubbing_moy", "sport_moy", "exercice_moy"  , 
    "attr1_avg_moy" ,   
     "attr4_avg_moy" ,  "attr5_avg_moy",  "sinc4_avg_moy" , 
     "intel1_avg_moy" ,  
     "fun1_avg_moy" , "fun3_avg_moy" ,  
     "amb4_avg_moy" , "shar2_avg_moy" , "same_field_cd","same_date" ,  "same_go_out" , 
      
     "same_race" , 
    "race_4" , "race_2", "match", "distance")


#varListe = c("id", "pid", "go_out_6", "same_gender", paste0("field_cd_",1:18),paste0("career_c_",1:17),paste0("go_out_",1:7), "sports_ect","tvsports_ect","exercise_ect","dining_ect","museums_ect","art_ect","hiking_ect","gaming_ect","clubbing_ect","reading_ect","tv_ect","theater_ect","movies_ect","concerts_ect","music_ect","shopping_ect","yoga_ect",paste0("attr",1:5,"_avg_ect"),paste0("sinc",1:5,"_avg_ect"),paste0("intel",1:5,"_avg_ect"),paste0("fun",1:5,"_avg_ect"),paste0("amb",1:5,"_avg_ect"),paste0("shar",c(1,2,4),"_avg_ect"), "intel5_avg_moy", "fun5_avg_moy", "attr5_avg_moy", "shar5_avg_moy", "amb5_avg_moy", "intel_aveg_moy", "fun4_avg_moy", "attr4_avg_moy", "shar4_avg_moy", "undergra_0", "undergra_1", "gender_0", "gender_1" )
...
```{r}
#df_mod = df_couple2[,which(names(df_couple2) %in% varSignificatifs)]
df_mod = df_couple2[,which(names(df_couple2) %in% varSignificatifs2)]
