...
#Split
resu=creationDesData(df_mod$df,var_signif)
df_mod = resu$df_mod;train_data = resu$dapp;dtest = resu$dtest
...
k<<-0;pb<<-txtProgressBar(style = 3,width = 50)
rf_fit_rose <- caret::train(match ~., data = train_data, method = "xgbTree",trControl=ctrl_rose,tuneGrid = tune_grid,tuneLength = 10,preProcess = c("scale", "center"),metric = "F1")
plot(rf_fit_rose)
# Testing
