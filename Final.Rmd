...
plot(rf_fit)
# Testing
f1_eval=t(best_f1(rf_fit,test_data))
...
plot(rf_fit_up)
# Testing
f1_eval2=t(best_f1(rf_fit_up,test_data))
...
plot(rf_fit_down)
# Testing
f1_eval3=t(best_f1(rf_fit_down,test_data))
#plot(f1_eval3$seuil,f1_eval3$F1)
test_model(test_data,rf_fit_down,f1_eval3$seuil[which.max(f1_eval3$F1)])

#Comaraison
f1_eval=as.data.frame(f1_eval);f1_eval$methode="normal"
f1_eval2=as.data.frame(f1_eval2);f1_eval2$methode="sur-échantillonnage"
f1_eval3=as.data.frame(f1_eval3);f1_eval3$methode="sous-échantillonnage"
