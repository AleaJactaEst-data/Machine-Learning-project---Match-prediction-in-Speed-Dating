...
tune_grid <- expand.grid(C=c(10,100,500,1000), sigma = seq(0.1,1,0.1))

mod.svm <- train(match ~., data = dapp, method = "svmRadial",trControl=ctrl,tuneGrid = tune_grid,tuneLength = 10,preProcess = c("scale", "YeoJohnson"), metric = "F1")
