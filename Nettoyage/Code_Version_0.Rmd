...
tune_grid <- expand.grid(cost=c(10,100,500,1000),gamma = seq(0.1,1,0.1))

mod.svm <- train(match ~., data = dapp, method = "svmRadial",trControl=ctrl,tuneGrid = tune_grid,tuneLength = 10,preProcess = c("scale", "center"), metric = "F1")
